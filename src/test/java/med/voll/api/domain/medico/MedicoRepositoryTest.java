...
class MedicoRepositoryTest {
	...
	void escolherMedicoAleatorioLivreNaDataCenario1() {
		...
		//given ou arrange (dadas as condições)	
		...
		//when ou act (quando eu disparar essa ações)
		Medico medicoLivre = medicoRepository.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA, proximaSegundaAs10);

		//then ou assert (esse é o resultado esperado (?))
		assertThat(medicoLivre).isNull();
	}
	
	@Test
	@DisplayName("Deveria devolver médico quando ele estiver livre na data")
